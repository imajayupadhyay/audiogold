    ...
    <section id="contact" class="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-emerald-50 via-white to-teal-50">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="text-center mb-16">
                ...
                <div class="w-24 h-1 bg-gradient-to-r from-audiogold-500 to-audiogold-700 mx-auto rounded-full mt-4"></div>
            </div>

            <div class="grid md:grid-cols-2 gap-12">
                <!-- Contact Form -->
                <div class="backdrop-blur-md bg-white/60 rounded-3xl p-8 md:p-10 shadow-2xl border border-white/50">
                ...
                <div class="backdrop-blur-md bg-white/60 rounded-3xl p-8 md:p-10 shadow-2xl border border-white/50">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start space-x-4">
                            <div class="backdrop-blur-sm bg-audiogold-100 rounded-xl p-3">
