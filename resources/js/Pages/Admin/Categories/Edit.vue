                ...
                <form @submit.prevent="submitForm" class="px-8 py-6 space-y-6">
                    ...
                    <div>
                        ...
                        <div v-if="currentImage && !imagePreview" class="mb-4">
                            ...
                            <div class="relative w-48 h-48 rounded-lg overflow-hidden bg-gray-100 border-2 border-gray-200">
                                <img :src="currentImage" alt="Current" class="w-full h-full object-cover">
                                <button
                                    @click="removeCurrentImage"
                                    type="button"
                                    class="absolute top-2 right-2 p-2 bg-red-500 hover:bg-red-600 text-white rounded-lg transition-colors duration-200"
                                >
                        ...
                        <!-- Image Upload -->
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-600 mb-2">Upload New Image</label>
                            <input
...
const form = useForm({
    ...
    features: props.category.features && props.category.features.length > 0 ? props.category.features : [''],
