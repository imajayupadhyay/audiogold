<template>
    <Head title="Create Product - AudioGold Admin" />
        ...
        <div class="max-w-5xl">
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                <div class="px-8 py-6 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
                    ...
                    <p class="text-gray-600 mt-1">Create a new product for your catalog</p>
                </div>
                ...
                <form @submit.prevent="submitForm" class="px-8 py-6 space-y-8">
                    ...
                    <div class="space-y-6 pt-6 border-t border-gray-200">
                        ...
                        <!-- Image Upload -->
                        <div>
                            <label class="block text-sm font-medium text-gray-600 mb-2">Upload Images</label>
                            <input
                        ...
                        <!-- Image URLs -->
                        <div>
                            <label class="block text-sm font-medium text-gray-600 mb-2">Image URLs</label>
                            <div class="space-y-3">
                        ...
                        <div v-if="imagePreviews.length > 0" class="mt-4">
                            ...
                            <div class="grid grid-cols-4 gap-4">
                                <div v-for="(preview, index) in imagePreviews" :key="index" class="relative w-full aspect-square rounded-lg overflow-hidden bg-gray-100 border-2 border-gray-200">
                    ...
                    <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                        ...
                        >
                            <span v-if="!processing">Create Product</span>
