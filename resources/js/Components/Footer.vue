        ...
        <!-- Newsletter Section -->
            ...
            <div class="grid md:grid-cols-3 gap-12 mb-12">
                ...
                <div>
                    ...
                    <p class="text-gray-300 mb-6">
                        Making premium audio technology accessible to all. Professional-grade equipment for the Indian market.
                    </p>
                    <!-- Social Media Icons -->
                    <div class="flex space-x-4">
                        <a href="#" class="w-10 h-10 rounded-full bg-white/10 hover:bg-audiogold-600 flex items-center justify-center transition-colors duration-200">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="/" class="text-gray-300 hover:text-audiogold-400 transition-colors duration-200">Home</a></li>
                        <li><a href="#products" class="text-gray-300 hover:text-audiogold-400 transition-colors duration-200">Products</a></li>
                        <li><a href="#about" class="text-gray-300 hover:text-audiogold-400 transition-colors duration-200">About us</a></li>
                        <li><a href="#faq" class="text-gray-300 hover:text-audiogold-400 transition-colors duration-200">FAQ's</a></li>
                        <li><a href="#support" class="text-gray-300 hover:text-audiogold-400 transition-colors duration-200">Support</a></li>
                        <li><a href="#contact" class="text-gray-300 hover:text-audiogold-400 transition-colors duration-200">Contact</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start space-x-3">
                            ...
                            <a href="mailto:shivamelectronics7@gmail.com" class="text-gray-300 hover:text-audiogold-400 transition-colors duration-200 break-all">
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <a href="tel:+917011651721" class="text-gray-300 hover:text-audiogold-400 transition-colors duration-200">
                                +91 7011651721
                            </a>
                        </div>
                        <div class="flex items-start space-x-3">
                            ...
                            <p class="text-gray-300">A-64 Roop nagar industrial area, Loni Ghaziabad</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="pt-8 border-t border-white/20 text-center">
                <p class="text-gray-400">
                    ©2025. AudioGold.in All Rights Reserved.
                </p>
            </div>
        </div>
    </footer>
